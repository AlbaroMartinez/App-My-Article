...
//            private final android.support.v4.util.LruCache<String, Bitmap> cache = new android.support.v4.util.LruCache<String, Bitmap>(10);
        ...
        StringRequest peticion = new StringRequest(Request.Method.GET, "https://my-favorite-places-57c12-default-rtdb.firebaseio.com/Articulos.json", new Response.Listener<String>() {
            @Override
